...
\end{lstlisting}
The helper functions that are contained in the contract factory that allow authentication services to better track newly created contracts look as follows.
