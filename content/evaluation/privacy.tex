...
\hline
User-Pseudonym Unlinkability & The true identity of a user is not linkable to any pseudonym they use. & By knowing the identity of a user, it is not possible to identify pseudonyms that belong to the user as there is no information contained in the pseudonym that would allow us to make this connection. & Yes\\
\hline
