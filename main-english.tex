...
\usepackage[
  title={A Privacy-preserving Platform for Ride-Pooling},
  author={Hans Hüppelshäuser},
  type=master,
  institute=iaas, % or other institute names - or just a plain string using {Demo\\Demo...}
  course={Wirtschaftsinformatik},
  examiner={Prof.\ Dr.\ Marco Aiello},
  supervisor={M.Sc.\ Robin Pesl},
...
\section{Prototype Development Smart Contracts}
\section{Prototype Development User Frontend}
\section{Prototype Development Matching Service}
\section{Prototype Development Virtual Car}
...
\chapter{Limitations and Outlook}
